...
namespace Kiran
{
KSMClientXsmp::KSMClientXsmp(const std::string &startup_id,
                             SmsConn sms_connection) : KSMClient(startup_id),
...
bool KSMClientXsmp::cancel_end_session()
{
    SmsShutdownCancelled(this->sms_connection_);
    return true;
}

bool KSMClientXsmp::query_end_session(bool interact)
{
...
bool KSMClientXsmp::end_session(bool save_data)
{
    SmsSaveYourself(this->sms_connection_,
...
bool KSMClientXsmp::end_session_phase2()
{
    SmsSaveYourselfPhase2(this->sms_connection_);
    return true;
}

bool KSMClientXsmp::stop()
{
    SmsDie(this->sms_connection_);
    return true;
}

void KSMClientXsmp::update_property(SmProp *property)
{
...
void KSMClientXsmp::delete_property(const std::string &property_name)
{
...
SmProp *KSMClientXsmp::get_property(const std::string &property_name)
{
    auto index = this->get_property_index(property_name);
...
std::string KSMClientXsmp::get_program_name()
{
...
std::string KSMClientXsmp::prop_to_command(SmProp *property)
{
    std::string retval;

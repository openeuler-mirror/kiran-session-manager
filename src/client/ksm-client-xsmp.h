...
class KSMClientXsmp : public KSMClient
{
public:
    KSMClientXsmp(const std::string &startup_id, SmsConn sms_connection);
    virtual ~KSMClientXsmp();

    KSMClientType get_type() { return KSMClientType::KSM_CLIENT_TYPE_XSMP; };

...
KSMScreenSaver::KSMScreenSaver()
{
}

void KSMScreenSaver::init()
{
    try
    {
...
uint32_t KSMScreenSaver::add_throttle(const std::string& reason)
{
...
uint32_t KSMScreenSaver::lock_and_throttle(const std::string& reason)
{
    KLOG_PROFILE("reason: %s.", reason.c_str());
...
bool KSMScreenSaver::remove_throttle(uint32_t cookie)
{
